...
class RRT:
    ...
    def steer(self, from_node, to_node, extend_length=float("inf")):
        """Create a new tree node by moving from one node toward another."""
    ...
    def generate_final_course(self, goal_ind):
        """Trace parent links from a goal node back to the start."""
    ...
    def calc_dist_to_goal(self, x, y):
        """Compute Euclidean distance from a point to the RRT goal."""
        dx = x - self.end.x
        dy = y - self.end.y
        return math.hypot(dx, dy)

    def get_random_node(self):
        """Sample a random free-space node, occasionally biasing toward the goal."""
    ...
    def draw_graph(self, rnd=None):
        """Draw the current RRT tree for debugging/animation."""
        plt.clf()
    ...
    def get_nearest_node_index(node_list, rnd_node):
        """Return the index of the tree node closest to a random sample."""
    ...
    def check_collision(node, obstacleList):
        """Return True when a candidate node path is collision-free."""
    ...
    def calc_distance_and_angle(from_node, to_node):
        """Return distance and bearing from one RRT node to another."""
...
def main():
    """Run the original standalone RRT demo."""
    ...
    obstacleList = [
        ...
        (41, 6), (41, 7), (41, 8), (41, 9), (41, 10), (41, 11), (41, 12), (41, 13), (41, 14), (41, 15), (41, 16), (41, 17), 
        (41, 18), (41, 19), (41, 20), (41, 21), (41, 22), (41, 23), (41, 24), (41, 25), (41, 26), (41, 27), (41, 28), (41, 29),
        (41, 30), (41, 31), (41, 32), (41, 33), (41, 34), (41, 35), (41, 36), (41, 37), (41, 38), (41, 39), (41, 40), (40, 39),
        (39, 39), (38, 39), (37, 39), (37, 38), (37, 37), (37, 36), (37, 35), (37, 34), (36, 34), (35, 34), (34, 34), (33, 34),
        (32, 34), (31, 34), (30, 34), (29, 34), (28, 34), (27, 34), (26, 34), (25, 34), (24, 34), (23, 34), (22, 34), (21, 34),
        (20, 34), (19, 34), (18, 34), (17, 34), (16, 34), (15, 34), (14, 34), (13, 34), (12, 34), (11, 34), (10, 34), (9, 34),
        (8, 34), (7, 34), (6, 34), (5, 34), (4, 34), (3, 34), (2, 34), (1, 34), (0, 34), (0, 33), (0, 32), (0, 31), (0, 30),
        (0, 29), (0, 28), (0, 27), (0, 26), (0, 25), (0, 24), (0, 23), (0, 22), (0, 21), (0, 20), (0, 19), (0, 18), (0, 17), 
        (0, 16), (0, 15), (0, 14), (0, 13), (0, 12), (0, 11), (0, 10), (0, 9), (0, 8), (0, 7), (0, 6), (0, 5), (0, 4), (0, 3), (0, 2),
        ...
        (21, 14), (22, 14), (23, 14), (24, 14), (25, 14), (26, 14), (27, 14), (28, 14), (29, 14), (30, 14), (31, 14), (32, 14), 
        ...
        (25, 26), (24, 26), (23, 26), (22, 26), (21, 26), (20, 26), (19, 26), (18, 26), (17, 26), (16, 26), (15, 26), (14, 26),
        (13, 26), (12, 26), (11, 26), (10, 26), (9, 26), (8, 26), (7, 26), (6, 26), (5, 26), (4, 26), (3, 26), (2, 26), (1, 26), (0, 26),  
